...
class Pedidos():
    ...
    def tipoProducto(self):
        ...
        mycursor.execute("SELECT nombre_silla,foto_silla FROM tipo_silla")
    ...
    def colorTela(self,id_tela):
        mycursor =self.mydb.cursor()
        mycursor.execute("SELECT nombre_color,foto_color FROM tela_color WHERE id_tela="+str(id_tela))
        myresult = mycursor.fetchall()
        return myresult
